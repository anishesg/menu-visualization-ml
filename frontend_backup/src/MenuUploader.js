          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-gray-600 text-sm sm:text-base">
             ...
             {menuData.map((item, index) => (
               <div key={index} className="menu-item-card rounded-xl overflow-hidden">
                 <div className="relative">
                   {item.image ? (
                     <img
                       src={item.image}
                       alt={item.item}
                       className="menu-item-image w-full rounded-t-xl"
                       onError={(e) => {
                   ...
                   <div className={`menu-item-image w-full bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center rounded-t-xl ${item.image ? 'hidden' : 'flex'}`}>
                 ...
                 <div className="p-4">
                   <h3 className="font-bold text-sm sm:text-base text-gray-800 leading-tight line-clamp-2 mb-2">
